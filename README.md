# Technical Certifications & Credentials Portfolio

This repository serves as a centralized, transparent ledger of my academic and professional achievements. It documents my continuous learning journey across **Artificial Intelligence, Large Language Models, and Web Development**, alongside my practical experience in national hackathons and industry virtual experiences.

Every credential listed here is backed by verifiable documentation located within the `/assets` directory.

---

## ─── 💡 Core AI & Technical Certifications ───
